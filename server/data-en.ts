...
export const recipesEn: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "2-6", name: "potatoes, peeled and quartered", amount: "4-6 pcs" },
      ...
      { id: "2-10", name: "salt", amount: "1-2 tsp" },
      { id: "2-11", name: "pepper", amount: "1-2 tsp" },
    ],
    description:
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "3-4", name: "milk", amount: "1.5-2 dl" },
      { id: "3-5", name: "butter", amount: "2 tbsp" },
      { id: "3-6", name: "salt", amount: "1 tsp" },
      { id: "3-7", name: "pepper", amount: "1/2 tsp" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "4-8", name: "lime", amount: "1/2 pc" },
      ...
      { id: "4-12", name: "heavy cream", amount: "1.5 dl" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "5-5", name: "pepper", amount: "1/2 tsp" },
      ...
      { id: "5-11", name: "liquid honey", amount: "1-2 tbsp" },
