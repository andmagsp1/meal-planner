...
export const recipes: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { id: "1-7", name: "salt", amount: "1 ts" },
      { id: "1-8", name: "pepper", amount: "1 ts" },
    ],
    description:
      "Enkel oppskrift på wok med kylling og nudler - rask, god og litt sunnere mat. Her bruker vi ferdig kuttede, sprø grønnsaker som kål og brokkoli. Bland det hele sammen med en veldig god og smaksrik hoisin woksaus. Asiatisk kyllingwok går raskt å lage, og er perfekt middag for hele familien i en travel hverdag.",
    steps:
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "2-6", name: "poteter, skrelt og delt i 4", amount: "5 stk" },
      ...
      { id: "2-10", name: "salt", amount: "1 ts" },
      { id: "2-11", name: "pepper", amount: "1 ts" },
    ],
    description:
      "En gryte som lager seg selv er perfekt i hverdagen. Alt du trenger å gjøre er å blande alt i gryten og la den stå og putre i en halvtime.",
    steps:
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "3-4", name: "melk", amount: "2 dl" },
      { id: "3-5", name: "smør", amount: "2 ss" },
      { id: "3-6", name: "salt", amount: "1 ts" },
      { id: "3-7", name: "pepper", amount: "1 ts" },
      { id: "3-8", name: "parmesan", amount: "50 g" },
    ],
    description:
      "Denne retten er en klassiker som originalt inneholder klippfisk. Da kalles den for brandade. Men den er også skikkelig god når man bruker fersk fisk.",
    steps:
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "4-8", name: "lime", amount: "1 stk" },
      { id: "4-9", name: "salt", amount: "1 ts" },
      { id: "4-10", name: "frisk koriander", amount: "til pynt" },
      { id: "4-11", name: "olje til steking", amount: "2 ss" },
    ...
    description:
      "Denne kyllinggryten passer godt enten det er en travel hverdag eller du vil lage noe godt i løpet av helgen. Rød karripasta er med på å tilføre denne retten asiatiske smaker. Prøv deg gjerne frem til riktig mengde.",
    steps:
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "5-5", name: "pepper", amount: "1 ts" },
      ...
      { id: "5-11", name: "flytende honning", amount: "1 ss" },
    ...
    description:
      "Dette er en «non spicy» versjon av «Korean Fried Chicken». Her får du en perfekt balanse mellom det søte, syrlige og litt salte – sammen med herlig aromatisk sesamolje og frø.",
    steps:
