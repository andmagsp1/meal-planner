...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description:
      "Varm opp rapsoljen på middels varme i en stor gryte, for eksempel en jerngryte. Ha i den hakkede løken. La løken surre til den blir blank. Ha i kyllingen og stek den sammen med løken et par minutter. Bland inn melet og ha i tomatene, poteter og gulrøtter. La retten stå og småkoke under lokk i 20-30 minutter, til kyllingen er gjennomkokt og potetene møre. Ha i bønnene og honningen. La gryten småkoke på svak varme i 5 minutter. Dersom gryten er for tykk, kan du ha i litt vann. Smak til med salt og pepper.",
  },
  {
    id: "3",
    ...
    description:
      "Sett ovnen på 200 grader varmluft. Skrell potetene, del dem i ca. 1 cm tykke skiver og legg dem i en kjele sammen med hele hvitløkfedd. Fyll opp med vann slik at det så vidt dekker og kok potetskivene møre under lokk. Det tar ca. 10–15 minutter, avhengig av potetene. Kutt fisken i omtrent 2x2 cm store biter. Når potetene er ferdig kokt siles vannet av og potetenes dampes lett. Tilsett melk og smør eller olivenolje og bland godt sammen med en visp eller potetmoser. Tilsett salt, pepper og fiskebitene. Vend godt sammen med en slikkepott og ha det hele over i en ildfast form. Dryss revet parmesan på toppen. Sett formen på et stekebrett kledd med bakepapir (det kan renne litt av formen og da er det greit å ha et bakepapir under) og sett det hele inn i ovnen. Stek i ca. 20 minutter til alt er gjennomvarmt og overflaten er gyllen. Skru gjerne på grillelementet mot slutten, men pass godt på slik at det ikke svir seg. Server gjerne fiskegratengen med ovnsbakte grønnsaker, som du med fordel kan steke samtidig med fisken, og en frisk salat.",
  },
  {
    id: "4",
    ...
    description:
      "Start med å koke risen. Det er trolig den som kommer til å ta lengst tid. Skjær kyllingfiletene i biter, og stek dem kjapt i en tykkbunnet gryte eller stekepanne i en klunk med olje. Mens kyllingen steker skreller du gulrøttene og skraper frøene ut av chilien. Kutt gulrøttene og paprikaen i terninger. Finhakk chilien. Ha gulrot, paprika og chili sammen med kyllingen når den har fått litt farge. Skrell og finhakk hvitløkfeddene og ingefæren, og ha i sammen med resten. Lag en liten grop i midten av stekepannen eller gryten, og legg i et par teskjeer med curry paste. La karripastaen frese et par minutter i pannen. Tilsett litt mer olje dersom det er tørt i bunnen. Samtidig som kyllingen og grønnsakene surrer, gjør du klart ingrediensene til sausen. Ha kremfløten, kokosmelken, kyllingbuljongen og soyasausen i en bolle. Rør maisennaen ut i en liten skvett med kaldt vann, og ha den i fløteblandingen. Hell sausen over kyllingen og grønnsakene. Kok opp og la gryten trekke i 5–7 minutter, til den tykner og kyllingen er gjennomstekt. Skvis over limesaft og smak til med salt rett før servering. Server kyllinggryten med et dryss av frisk koriander, grovhakkede peanøtter og kokt ris.",
  },
  {
    id: "5",
    ...
    description:
      "Del kyllingen i terninger på 3 × 3 centimeter. Hell eggehviten over kyllingen så alt dekkes. Bland mel, maisenna, salt og pepper i en bolle, og vend kyllingen i melblandingen. Eggehviten gjør at blandingen fester seg til kjøttet. Varm opp olje til frityrsteking på middels høy varme. Bruk nok olje til at den dekker kyllingen. Frityrstek kjøttet i cirka fem minutter eller til kyllingen får en lys gyllen farge og blir sprø. Legg i litt og litt av gangen, så ikke temperaturen blir for lav. Legg kyllingen på en rist eller et papir til avrenning. Bland sammen alle ingrediensene til sausen. Smak til med honning etter hvor søt saus du vil ha. Gjør klar en stekepanne på middels høy varme og tilsett sausen når pannen er varm. La den putre i cirka ett minutt, senk så varmen og ha i kyllingen. Vend kyllingen i sausen og la den få sette seg i ett minutt. Ta stekepannen av varmen. Dryss over vårløk og ekstra sesamfrø. Serveres med kokt ris.",
  },
];
